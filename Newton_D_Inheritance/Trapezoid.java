...
/**
 * Public class representing a Trapezoid inheritted from Quadrilateral
 */
public class Trapezoid extends Quadrilateral {
    ...
    /**
     * Get area method to calculate a trapezoid area with formula
     * @return a double representing the area
     */
    public double getArea() {
        return ((getp1().getDistance(getp4()) + getp2().getDistance(getp3())) / 2) * getp2().getDistanceBetweenTwoValues(getp2().getY(), getp1().getY());
    }
}