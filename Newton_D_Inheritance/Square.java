...
/**
 * Public class representing a Square inheritted from Rectangle
 */
public class Square extends Rectangle{
    /**
     * Default constructor calls Rectangle constructor to create 4 points
    ...
    /**
     * Get area method to calculate a square area with formula
     * @return a double representing the area
     */
    public double getArea() {
        return Math.pow(getp1().getDistance(getp2()), 2);
    }
}
